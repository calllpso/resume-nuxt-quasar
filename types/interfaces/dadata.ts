...
export type AddressBeltwayHit = "IN_MKAD" | "OUT_MKAD" | "IN_KAD" | "OUT_KAD";
...
export type AddressBounds = "country" | "region" | "area" | "city" | "settlement" | "street" | "houses";

export type PartyType = "LEGAL" | "INDIVIDUAL";

export type PartyBranchType = "MAIN" | "BRANCH";

export type PartyStatus = "ACTIVE" | "LIQUIDATING" | "LIQUIDATED" | "REORGANIZING" | "BANKRUPT";

export interface PartyAddress extends Omit<Address, "qc" | "house_cadnum" | "stead_kladr_id" | "floor" | "flat_price"> {
    qc: "0" | "1" | "3";
...
export type BankType = "BANK" | "BANK_BRANCH" | "NKO" | "NKO_BRANCH" | "RKC" | "OTHER";
